...
class CiConfigTests(unittest.TestCase):
    def test_github_actions_workflow_exists_and_runs_unittest(self) -> None:
        ...
        self.assertTrue("python -m unittest discover -s tests" in text or "python -m pytest project/tests/" in text)
    ...
    def test_wsl_local_ci_scripts_mirror_ubuntu_job(self) -> None:
        ...
        testing_doc = ROOT / "project" / "docs" / "development" / "TESTING.md"
        wsl_doc = ROOT / "project" / "docs" / "development" / "WSL_CI.md"
