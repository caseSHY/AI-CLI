...
class DocsGovernanceTests(unittest.TestCase):
    def test_copilot_and_agent_instruction_entry_points_exist(self) -> None:
        required_files = [
            ...
            "project/docs/agent-guides/DOC_GOVERNANCE_RULES.md",
            "project/docs/agent-guides/FACT_PROPAGATION_MATRIX.md",
        ]
        ...
        for required in [
            "project/docs/status/CURRENT_STATUS.md",
            "project/docs/agent-guides/DOC_GOVERNANCE_RULES.md",
            "project/docs/agent-guides/FACT_PROPAGATION_MATRIX.md",
    ...
    def test_agent_governance_guides_are_indexed(self) -> None:
        docs_index = read_text("project/docs/README.md")
    ...
    def test_testing_doc_ci_topology_matches_workflow(self) -> None:
        ...
        testing = read_text("project/docs/development/TESTING.md")
    ...
    def test_governance_report_keeps_untriggered_ci_as_pending(self) -> None:
        report = read_text(
            "project/docs/reports/project-governance/2026-04-30-project-structure-and-docs-governance-report.md"
        )
        self.assertIn(
    ...
    def test_current_docs_do_not_contain_known_stale_current_facts(self) -> None:
        current_docs = [
            ...
            "project/docs/status/CURRENT_STATUS.md",
            "project/docs/reference/SECURITY_MODEL.md",
            "project/docs/audits/GNU_COMPATIBILITY_AUDIT.md",
            "project/docs/guides/USAGE.zh-CN.en.md",
        ]
        forbidden = [
            "现有 99 个测试全部通过",
            "99 passed",
