...
| Agent/Copilot 规则 | `docs/agent-guides/CLAUDE.md` (行为准则权威来源), `.github/instructions/*.instructions.md` (项目特定规则) | `AGENTS.md`, `.github/copilot-instructions.md`, `docs/README.md`, `docs/agent-guides/` |
...
| Agent/Copilot rules | `docs/agent-guides/CLAUDE.md` (authoritative behavioral guidelines), `.github/instructions/*.instructions.md` (project-specific rules) | `AGENTS.md`, `.github/copilot-instructions.md`, `docs/README.md`, `docs/agent-guides/` |
