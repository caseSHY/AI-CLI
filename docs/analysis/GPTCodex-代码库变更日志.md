...
- `docs/architecture/CLAUDE.md`：AI 编码行为准则文档，已存在；当前只移动位置。
...
- `docs/architecture/CLAUDE.md`, the archived test report, and the original `GPTCodex-vs-DeepSeekCopilot` analysis log.
