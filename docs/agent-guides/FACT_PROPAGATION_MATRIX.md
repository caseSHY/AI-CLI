...
| 命令数量 | `python -m agentutils schema` | `README.md`, `docs/status/CURRENT_STATUS.md`, `docs/audits/GNU_COMPATIBILITY_AUDIT.md`, `docs/reference/AGENTUTILS.md` |
...
| Command count | `python -m agentutils schema` | `README.md`, `docs/status/CURRENT_STATUS.md`, `docs/audits/GNU_COMPATIBILITY_AUDIT.md`, `docs/reference/AGENTUTILS.md` |
