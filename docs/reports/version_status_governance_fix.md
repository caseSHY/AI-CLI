...
| `docs/status/CURRENT_STATUS.md` | commit hash、CI 状态措辞、版本一致性状态、macOS runner 矩阵 |
...
| `docs/architecture/DOC_GOVERNANCE_RULES.md` | 新增版本治理规则（7 条强制规则） |
| `docs/reports/version_status_governance_fix.md` | 本文档 |
